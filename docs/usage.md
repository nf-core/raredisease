...
| platform                       | known_dbsnp<sup>5</sup>        |
| mito_name/mt_fasta<sup>3</sup> | known_dbsnp_tbi<sup>5</sup>    |
...
<sup>4</sup>fasta_fai and bwamem2, if not provided by the user, will be generated by the pipeline when necessary.<br />
