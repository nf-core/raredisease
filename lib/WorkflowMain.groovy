//
// This file holds several functions specific to the main.nf workflow in the nf-core/raredisease pipeline
//
...
class WorkflowMain {
    ...
    public static String citation(workflow) {
        return "If you use ${workflow.manifest.name} for your analysis please cite:\n\n" +
            // nf-core: Add Zenodo DOI for pipeline after first release
            //"* The pipeline\n" +
