...
workflow RAREDISEASE {
    ...
    ch_gnomad_vcf_unprocessed         = params.gnomad_vcf             ? Channel.fromPath(params.gnomad_vcf).collect()
                                                                      : Channel.empty()
    ch_intervals_wgs                  = params.interval_wgs           ? Channel.fromPath(params.interval_wgs).collect()
                                                                      : Channel.empty()
    ch_intervals_y                    = params.interval_y             ? Channel.fromPath(params.interval_y).collect()
                                                                      : Channel.empty()
