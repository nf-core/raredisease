...
params.mt_shift_fasta       = WorkflowMain.getGenomeAttribute(params, 'mt_shift_fasta')
params.mt_shift_fasta_index = WorkflowMain.getGenomeAttribute(params, 'mt_shift_fasta_index')
params.mt_shift_fasta_chain = WorkflowMain.getGenomeAttribute(params, 'mt_shift_fasta_chain')
...
params.intervals_mt_shift   = WorkflowMain.getGenomeAttribute(params, 'intervals_mt_shift')
