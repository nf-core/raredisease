...
> [!IMPORTANT]
> Before contributing, please read the [**nf-core/raredisease Contributing Guidelines**](https://github.com/nf-core/raredisease/blob/dev/CONTRIBUTING_GUIDELINES.md) for pipeline-specific conventions, coding standards, and review expectations.
