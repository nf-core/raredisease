...
- **Reuse over duplication** — `RANK_VARIANTS`, `ANNOTATE_PLI`, `VCF_FILTER_BCFTOOLS_FILTERVEP`, and their composite `FILTER_ANNOTATE_RANK` wrapper are intentionally included multiple times under different aliases. Follow this pattern before creating a near-identical subworkflow.
