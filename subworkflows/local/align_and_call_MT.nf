...
workflow ALIGN_AND_CALL_MT {
    take:
        ...
        sequence_dict          // channel: [ genome.dict ]
    ...
    main:
        ...
        // Merges bam files
        GATK4_MERGEBAMALIGNMENT_MT (ch_fastq_ubam, fasta, sequence_dict )
        ...
        GATK4_MUTECT2_MT (ch_sort_index_bam_intervals_mt, fasta, fai, sequence_dict, [], [], [],[])
