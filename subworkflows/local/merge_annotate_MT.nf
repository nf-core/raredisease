...
//include { BCFTOOLS_CONCAT as BCFTOOLS_CONCAT_MT                  } from '../../modules/nf-core/bcftools/concat/main'
...
workflow MERGE_ANNOTATE_MT {
    ...
    main:
       ...
       //ch_vcfs_conc=vcf1.join(vcf2,by:[0])
       //BCFTOOLS_CONCAT_MT(ch_vcfs_conc)
       //ch_versions = ch_versions.mix(BCFTOOLS_CONCAT_MT.out.versions.first())

        GATK4_FILTERMUTECTCALLS_MT( vcf1, 
            fasta, 
            fai, 
            dict )
        ...
        //BCFTOOLS_MERGE_MT(ch_mergvc,[],fasta,fai)
        //ch_versions = ch_versions.mix(BCFTOOLS_MERGE_MT.out.versions.first())
        ...
        //ENSEMBLVEP_MT( REMOVE_DUPLICATES_MT.out.vcf,
