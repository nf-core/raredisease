...
workflow VARIANT_EVALUATION {
    ...
    emit:
        ...
        fn_tbi       = RTGTOOLS_VCFEVAL.out.fn_tbi       // channel: [ val(meta), path(tbi) ]
        fn_vcf       = RTGTOOLS_VCFEVAL.out.fn_vcf       // channel: [ val(meta), path(vcf) ]
        fp_tbi       = RTGTOOLS_VCFEVAL.out.fp_tbi       // channel: [ val(meta), path(tbi) ]
        fp_vcf       = RTGTOOLS_VCFEVAL.out.fp_vcf       // channel: [ val(meta), path(vcf) ]
        ...
        tp_tbi       = RTGTOOLS_VCFEVAL.out.tp_tbi       // channel: [ val(meta), path(tbi) ]
        tp_vcf       = RTGTOOLS_VCFEVAL.out.tp_vcf       // channel: [ val(meta), path(vcf) ]
