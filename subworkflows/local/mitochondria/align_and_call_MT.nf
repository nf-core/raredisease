...
workflow ALIGN_AND_CALL_MT {
    ...
    main:
        ...
        MT_DELETION(SAMTOOLS_STATS_MT.out.stats)
        ...
        ch_versions = ch_versions.mix(SAMTOOLS_STATS_MT.out.versions.first())
    ...
    emit:
        ...
        mt_del_script = MT_DELETION.out.mt_del_script        // channel: [ val(meta), path(txt) ]
