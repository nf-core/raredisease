...
- Migrate `qc_bam`'s real tests to the minimal dataset [issue #869](https://github.com/nf-core/raredisease/issues/869) [PR #TBD](https://github.com/nf-core/raredisease/pull/TBD)
