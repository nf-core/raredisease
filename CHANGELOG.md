...
- `bwafastalign/mem` nf-core module to support genome alignment with bwa-fastalign when `--aligner bwafastalign` is set [#877](https://github.com/nf-core/raredisease/pull/877)
