...
- Added allosome parameter for GATK GermlineCNVCaller to correctly call chrX and chrY CNVs for `call_sv_germlinecnvcaller` [issue #965](https://github.com/nf-core/raredisease/issues/965) [PR #966](https://github.com/nf-core/raredisease/pull/966)
