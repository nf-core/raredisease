...
- Migrate `prepare_references`'s and `scatter_genome`'s real tests to the minimal dataset [issue #869](https://github.com/nf-core/raredisease/issues/869) [PR #TBD](https://github.com/nf-core/raredisease/pull/TBD)
