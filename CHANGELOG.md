...
- Add a real (non-stub) test to `annotate_cadd` that scores 42 SNVs and indels across the minimal 9-region GIAB dataset against a trimmed CADD v1.7 GRCh38 prescored fixture (all-prescored path, no annotation bundle or reference needed) [issue #795](https://github.com/nf-core/raredisease/issues/795) [PR #1018](https://github.com/nf-core/raredisease/pull/1018)
