...
- Migrate `call_repeat_expansions`'s and `call_snv`'s real tests to the minimal dataset [issue #869](https://github.com/nf-core/raredisease/issues/869) [PR #TBD](https://github.com/nf-core/raredisease/pull/TBD)
