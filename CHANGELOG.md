...
- Migrate `align_mitochondria`'s and `convert_mt_bam_to_fastq`'s real tests to the minimal dataset [issue #795](https://github.com/nf-core/raredisease/issues/795) [PR #TBD](https://github.com/nf-core/raredisease/pull/TBD)
