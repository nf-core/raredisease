...
- Migrate `call_sv_MT`'s real tests to the minimal dataset[issue #795](https://github.com/nf-core/raredisease/issues/795) [PR #TBD](https://github.com/nf-core/raredisease/pull/TBD)
