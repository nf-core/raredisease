...
- Removed logic where we added an arbitrary substring to keep file names unique after alignment, and then split those string to get at the original string before merging with a simple copy operation. [#425](https://github.com/nf-core/raredisease/pull/425/files)
