...
3. Variant calling + multiple calls are aggregated: [`DNAscope`](https://support.sentieon.com/manual/DNAscope_usage/dnascope/)
...
4. Annotation: [`VCFanno`](https://github.com/brentp/vcfanno),[`VEP`](https://www.ensembl.org/info/docs/tools/vep/index.html)
    ...
    2. SVs:
    3. Mitochondria: [`eKLIPse`](https://github.com/dooguypapua/eKLIPse), [`gnomAD_mt`](https://gnomad.broadinstitute.org/downloads#v3-mitochondrial-dna), [`Haplogrep`](https://github.com/seppinho/haplogrep-cmd/tree/v2.1.21), [`HmtNote`](https://github.com/robertopreste/HmtNote)
